...
import { 
  Code2, Save, FileText, GitBranch, Search, 
  Settings, Maximize2, Minimize2, Eye, EyeOff,
  Bold, Italic, Link, List, CheckSquare, Type,
  Play, Square, Terminal, Globe, Database, Zap,
  Loader, ExternalLink, AlertCircle
} from 'lucide-react';

export const CodeEditor = () => {
  const { state, updateFileContent, addTerminalCommand } = useOS();
      ...
      <div className="flex-1 flex flex-col">
        <div className="flex-1 relative overflow-hidden" ref={editorRef}>
            ...
            <div className="absolute left-0 top-0 bottom-0 w-12 bg-gray-900/50 border-r border-gray-800 overflow-y-auto">
              <div className="py-4">
                {lines.map((_, i) => (
                  <div
                    key={i}
                    className={`text-right pr-3 text-xs font-mono h-6 flex items-center justify-end ${
                      i + 1 === cursorLine 
          ...
          <textarea
            ...
            className={`absolute inset-0 w-full h-full bg-transparent text-gray-300 font-mono focus:outline-none resize-none p-4 ${
